...
public class Action extends BaseClass  {
	...
	public String screenShot(WebDriver webDriver, String filename) {
		...
		String newImageString = "C:\\Users\\garvit.c.gupta\\eclipse-Selenium\\MyStoreProject\\Screenshot" + filename + "_"
				+ dateName + ".png";
